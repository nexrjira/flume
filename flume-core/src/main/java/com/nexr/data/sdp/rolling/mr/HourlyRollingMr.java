...
import org.apache.hadoop.mapred.HourlyOutputFormat;
...
public class HourlyRollingMr extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		JobConf jobConf = new JobConf(getConf(), HourlyRollingMr.class);
		jobConf.setInputFormat(SequenceFileInputFormat.class);
		jobConf.setMapperClass(IdentityMapper.class);
		jobConf.setReducerClass(UniqueKeyReduce.class);
		jobConf.setJobName("HourlyRollong");
		jobConf.setPartitionerClass(HourlyPartitioner.class);
		jobConf.setOutputFormat(HourlyOutputFormat.class);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new HourlyRollingMr(),
	        args);
	    System.exit(res);
	  }
}
